...
struct SpotifyPlaylistResponse {
    ...
    struct CreatePlaylist: Codable {
        ...
        var createPlaylistDescription: JSONNull?
        ...
        enum CodingKeys: String, CodingKey {
            case collaborative
            case createPlaylistDescription = "description"
            case externalUrls = "external_urls"
            case followers, href, id, images, name, owner
            case primaryColor = "primary_color"
            case createPlaylistPublic = "public"
